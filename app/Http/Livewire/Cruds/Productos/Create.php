...
class Create extends Component
{
    ...
    public function save(){
        ...
        $consulta = DB::table('productos')->where('producto_codigo', '=', $this->producto_codigo)->get();
        ...
        if($contador > 0){
            ...
            return redirect()->to('productos' . '/' . 'create')->with('alert-success', '¡Producto guardado con exito!');
    ...
    public function render()
    {
        ...
        return view('livewire.cruds.productos.create', compact('tipoproductos'));
    }
}
