...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Inventario Papelería',
            'icon'    => 'fas fa-fw fa-share',
            'can' => 'admin.papelerias.index',
            'submenu'=> [
                [
                    'text' => 'Productos papelería',
                    'route' => 'admin.papelerias.index',
                    'can' => 'admin.papelerias.index'
                ]
            ],
        ],
