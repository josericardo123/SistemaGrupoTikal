        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="">Precio por unidad (Proveedor):</label>
                            <input type="number" class="form-control" value="{{ $item->precio_unidad }}" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <a href="{{ route('admin.entradas.index') }}" class="btn btn-danger">Volver</a>
                </div>
                @endforeach
                </div>
            </div>
