        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-4">
                        @can('admin.tipoproductos.create')
                        ...
                        <tbody>
                            @foreach ($tipoproductos as $item)
                                ...
                                <tr>
                                    ...
                                    @can('admin.tipoproductos.show')
                                    <td>
                                        <a href="{{ route('admin.tipoproductos.show', $item->id ) }}"
                                            class="btn btn-primary btn-sm">
                                            <i class="fas fa-eye"></i></a>
                                    </td> 
                                    @endcan
                                    @can('admin.tipoproductos.edit')
                                    <td>
                                        <a href="{{ route('admin.tipoproductos.edit', $item->id ) }}"
                                            class="btn btn-primary btn-sm">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                    </td> 
                                    @endcan
                                    @can('admin.tipoproductos.destroy')
                                    <td>
