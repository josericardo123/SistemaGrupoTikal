<div>
    <div class="row mt-2">
        ...
        <div class="col-4">
                {{--@can('admin.entradas.create')
                <a href="{{ route('admin.salidas.create') }}" class="btn btn-primary">
             ...
             <table class="table table-bordered mt-4">
                 <thead>
                     <tr class="table-primary">
                        ...
                        <th wire:click="order('cantidad_salida')" class="col-3">
                            Cantidad de salida
                            {{-- Sort --}}
        ...
        <div class="mt-3">
            <p> Mostrando {{ $salidas->firstItem() }} a {{ $salidas->lastItem() }} de {{ $salidas->total() }} Entradas</p>
        </div>
         @else
             <div class="card-body">
                 <strong>No existe ningún registro de salidas</strong>
             </div>
         @endif
    </div>
 </div>
